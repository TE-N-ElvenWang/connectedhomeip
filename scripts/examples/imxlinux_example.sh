...
then 
    ...
    then
#        echo "sendrolon not found sdk root, but cross_compile set!"
    else
#        echo "sendrolon not found sdk root, not found cross_compile! exit"
        exit -1
    fi
else
#    echo "sendrolon found imx sdk root=" $IMX_SDK_ROOT
